...
const GxFantasyWorks = () => {
  ...
  return (
    <React.Fragment>
      <Row
        justify={"center"}
        className="relative px-0 md:px-5 pt-16 md:pt-28 xl:pt-[150px] bg-[radial-gradient(146.13%_118.42%_at_50%_-15.5%,rgba(255,255,255,0)_0%,rgba(255,255,255,0.16)_100%)] backdrop-blur-[30px] box-border"
      >
        ...
        <Row className="w-full px-0 md:px-32 py-0 md:py-32 items-center">
          {/** @DESC **/
          <Col xs={24} xl={12} className="w-full border-none md:border shadow-md bg-[#0B0E1B] py-1 md:py-16 px-7 md:px-24 block md:hidden">
          <div className="min-h-28 w-full">
            <Flex className="mb:0 mt-8 items-center justify-start gap-3 mb-4" wrap>
              <img
                src={BallOne}
            ...
            <Flex className="items-end justify-between">
              ...
              <div className="w-[25%] md:w-[15%]">
                ...
                <div>
                <img src={smallProgresBar} alt={"Progress"} title={"Progress"} className="w-full h-full"/>
                </div>
            ...
            {activeIcon && (
              <div className="w-full pt-3 text-white mb-4 md:mb-0">
                ...
                <div className="w-full relative pt-12">
                  <img src={bigProgresBar} alt={"Progress"} title={"Progress"} className="w-full h-full"/>
                </div>
              </div>
            )}
          </div>
        </Col>}
          <Col xs={24} xl={10} className="w-full px-4 md:px-0 py-6 md:py-0">
          ...
          <Col xs={24} xl={12} className="w-full border-none md:border shadow-md bg-[#0B0E1B] py-3 md:py-16 px-5 md:px-24 hidden md:block">
            <div className="min-h-28 w-full">
